# Audio [input from user] then to translated Audio

In this small script `run.py` the user will be asked to provide language
[source, destination]

* source: language of the user audio-input
...
Usage: run.py [OPTIONS]
  ...
  Main function to start the infinite loop for user audio-input. The function
  expects an input from microphone within phrase time limit, you can quit by
  repeatedly clicking CTRL+C
